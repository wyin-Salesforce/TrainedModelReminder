...
class RteProcessor(DataProcessor):
    ...
    def get_MNLI_as_train(self, filename):
        ...
        return examples, ["entailment", "neutral", "contradiction"]

    def get_SNLI_as_train(self, filename):
        '''
        classes: ["entailment", "neutral", "contradiction"]
        '''
        examples=[]
    ...
    def get_SciTail_as_train(self, filename):
        ...
        readfile.close()
        print('loaded  size:', line_co)
        return examples, ['entails', 'neutral']
    ...
    def get_RTE_as_train(self, filename):
        ...
        return examples, ['entailment', 'not_entailment']
...
def main():
    ...
    valid_examples_MNLI, label_list_MNLI = processor.get_MNLI_as_train('/export/home/Dataset/glue_data/MNLI/dev_mismatched.tsv')

    valid_features = convert_examples_to_features(
        valid_examples_MNLI, label_list_MNLI, args.max_seq_length, tokenizer, output_mode,
    ...
    train_examples_MNLI, label_list_MNLI = processor.get_MNLI_as_train('/export/home/Dataset/glue_data/MNLI/train.tsv') #train_pu_half_v1.txt
    train_examples_SNLI, label_list_SNLI = processor.get_SNLI_as_train('/export/home/Dataset/glue_data/SNLI/train.tsv')
