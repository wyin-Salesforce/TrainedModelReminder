...
def main():
    ...
    standard_model_name_or_path = 'roberta-large'
    model = AutoModelForSequenceClassification.from_pretrained(
        standard_model_name_or_path,
        from_tf=bool(".ckpt" in standard_model_name_or_path),
        config=config,
        cache_dir=model_args.cache_dir,
    )
    model.roberta.from_pretrained(model_args.model_name_or_path)#load_state_dict(model_roberta.roberta.state_dict())
